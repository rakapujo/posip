...
return new class extends Migration
{
    ...
    {
        Schema::create('doc_repack_output', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['repack_id', 'product_id'], 'unique_output_product_per_repack');
        });
    }
    ...
    {
        Schema::dropIfExists('doc_repack_output');
    }
};
