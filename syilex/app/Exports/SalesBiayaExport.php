...
class SalesBiayaExport implements FromQuery, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    ...
    public function query()
    {
        ...
        if ($applyNet) {
            $query->leftJoinSub(
                ReportHelperService::salesBiayaReturnByNotaSubquery($this->dateFrom, $this->dateTo, [
