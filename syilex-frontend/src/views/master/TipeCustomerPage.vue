...
const canExport = computed(() => authStore.can('tipe-customer.view'));
            ...
            >
                ...
                <Column :exportable="false" style="min-width: 220px" alignFrozen="right" frozen>
                    ...
                    <RowActionButtons>
                        ...
                        <Button v-if="canUpdate" icon="pi pi-pencil" rounded @click="editTipeCustomer(slotProps.data)" v-tooltip.top="'Edit'" aria-label="Edit" text />
