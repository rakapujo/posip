...
const canExport = computed(() => authStore.can('supplier.view'));
            ...
            >
                ...
                <Column :exportable="false" style="min-width: 220px" alignFrozen="right" frozen>
                    ...
                    <RowActionButtons>
                        ...
                        <Button v-if="canUpdate" icon="pi pi-pencil" rounded @click="editSupplier(slotProps.data)" v-tooltip.top="'Edit'" aria-label="Edit" text />
