    ...
    <div class="card">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="summary-stat-card bg-surface-50 dark:bg-surface-800 rounded-lg p-4">
                ...
                <div class="summary-money-value text-surface-900 dark:text-surface-0">{{ formatCurrency(summary.total_biaya_kirim) }}</div>
            </div>
            <div class="summary-stat-card bg-surface-50 dark:bg-surface-800 rounded-lg p-4">
                <div class="text-surface-500 text-sm mb-1">Total Biaya Lain</div>
                <div class="summary-money-value text-surface-900 dark:text-surface-0">{{ formatCurrency(summary.total_biaya_lain) }}</div>
            </div>
            <div class="summary-stat-card bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                ...
                <div class="summary-money-value text-blue-600 dark:text-blue-400">{{ formatCurrency(summary.total_biaya) }}</div>
            </div>
        </div>
