...
| localeMatcher        | HintedString<"lookup" \| "best fit">                  | best fit | The locale matching algorithm to use. Possible values are 'lookup' and 'best fit'; the default is 'best fit'. See Locale Negotation for details.                                                                                                                                                                                                                                               |
...
| roundingMode         | RoundingMode                                          | -        | How decimals should be rounded. The default value is `"halfExpand"` , further information.                                                                                                                                                                                                                                                                                 |
